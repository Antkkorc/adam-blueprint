...
export default function AuthPage() {
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    if (tab === "login") {
      ...
      // FIXED: 'redirectTo' renamed to 'emailRedirectTo' in new Supabase versions
        ...
        >
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-slate-400">
              Welcome back to Botswana&apos;s premium property platform
            </p>
          </div>
            ...
            {tab === "login" || tab === "register" ? (
              ...
              >
                ...
                <form onSubmit={handleEmailAuth} className="space-y-3">
                  ...
                  {tab === "login" && (
                    <button
                      ...
                      className="text-[11px] text-cyan-400 hover:underline w-full text-right"
                    >
                      Forgot password?
                    </button>
                  )}
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-white/5 border border-white/10 hover:border-cyan-500/30 text-cyan-400 text-xs font-bold flex items-center justify-center gap-2 transition-all btn-pop"
                >
                ...
                {phoneStep === "input" ? (
                  <form onSubmit={handleSendPhoneOtp} className="space-y-4">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-3 rounded-xl bg-cyan-400 text-slate-950 font-bold text-xs transition-all btn-pop neon-glow-hover flex items-center justify-center gap-2"
                    >
                      {loading ? (
                        <Loader2 className="w-4 h-4 animate-spin" />
                      ) : (
                  ...
                  <form onSubmit={handleVerifyOtp} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full text-[11px] text-cyan-400 hover:underline"
                    >
