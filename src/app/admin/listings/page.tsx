  ...
  return (
    <main className="min-h-screen bg-slate-950 p-6 text-white md:p-12">
      <div className="mx-auto max-w-4xl space-y-6">
        <div><BackToAdmin /><h1 className="text-3xl font-extrabold">Manage listings</h1><p className="mt-1 text-sm text-slate-400">Set availability or permanently delete published listings.</p></div>
